...
<head>
   ...
   <title>Ремонт сотовых телефонов samsung (самсунг) в Екатеринбурге | Компика</title>
<meta name="description" itemprop="description" content="Профессионально выполним ремонт всех видов телефонов компании самсунг. Даем гарантии на свою работу!" />
...
<body>
    ...
    <section class="repair-smartphone-content">
      <h1 class="repair-title">Ремонт смартфонов</h1>
      <div class="smartphone page-line">
        ...
        <a href="#smartphone-display" class="smartphone-content-navigation-display content-navigation">
        Замена дисплея
          <div class="nav-after"></div>
        </a>
        <img src="images/dot.png" width="11" height="11" alt="dot">
        <img src="images/dot-active.png" width="11" height="11" alt="dot-active" class="dot-active-smartphone-1 dot-active">


         <!--Кнопка Home-->

        <a href="#smartphone-buttons" class="smartphone-content-navigation-home-btn content-navigation">
        Замена кнопки<br> Home
          <div class="nav-after"></div>
        </a>
        <img src="images/dot.png" width="11" height="11" alt="dot">
        <img src="images/dot-active.png" width="11" height="11" alt="dot-active" class="dot-active-smartphone-2 dot-active">


        <!--Камера-->

        <a href="#smartphone-camera" class="smartphone-content-navigation-camera content-navigation">
        Замена камеры,<br>датчика приближения
          <div class="nav-after"></div>
        </a>
        <img src="images/dot.png" width="11" height="11" alt="dot">
        <img src="images/dot-active.png" width="11" height="11" alt="dot-active" class="dot-active-smartphone-3 dot-active">

        <!--Кнопка включения-->

        <a href="#smartphone-buttons" class="smartphone-content-navigation-button content-navigation">
        Замена кнопки<br>включения
          <div class="nav-after"></div>
        </a>
        <img src="images/dot.png" width="11" height="11" alt="dot">
        <img src="images/dot-active.png" width="11" height="11" alt="dot-active" class="dot-active-smartphone-5 dot-active">

        <!--Динамики-->

        <a href="#smartphone-dynamics" class="smartphone-content-navigation-speaker content-navigation">
        Замена динамиков
          <div class="nav-before"></div>
          <div class="nav-after"></div>
        </a>
        <img src="images/dot.png" width="11" height="11" alt="dot">
        <img src="images/dot-active.png" width="11" height="11" alt="dot-active" class="dot-active-smartphone-6 dot-active">



        <!--Аккумулятор-->

        <a href="#smartphone-battery" class="smartphone-content-navigation-battery content-navigation">
        Замена аккумулятора
          <div class="nav-after"></div>
        </a>
        <img src="images/dot.png" width="11" height="11" alt="dot">
        <img src="images/dot-active.png" width="11" height="11" alt="dot-active" class="dot-active-smartphone-8 dot-active">



        <!--Микрофон-->

        <a href="#smartphone-mic" class="smartphone-content-navigation-mic content-navigation">
        Замена микрофона
          <div class="nav-after"></div>
          <div class="nav-before"></div>
        </a>
        <img src="images/dot.png" width="11" height="11" alt="dot">
        <img src="images/dot-active.png" width="11" height="11" alt="dot-active" class="dot-active-smartphone-9 dot-active">
        ...
        <a href="#smartphone-buttons" class="smartphone-content-navigation-sound-btn content-navigation">
        Замена кнопоки<br> громкости
          <div class="nav-after"></div>
        </a>
        <img src="images/dot.png" width="11" height="11" alt="dot">
        <img src="images/dot-active.png" width="11" height="11" alt="dot-active" class="dot-active-smartphone-10 dot-active">
        ...
        <a href="#smartphone-headphones" class="smartphone-content-navigation-headphones content-navigation">
        Замена разъема<br> наушников
          <div class="nav-after"></div>
          <div class="nav-before"></div>
        </a>
        <img src="images/dot.png" width="11" height="11" alt="dot">
        <img src="images/dot-active.png" width="11" height="11" alt="dot-active" class="dot-active-smartphone-11 dot-active">



        <!--ПО-->

        <a href="#smartphone-po" class="smartphone-content-navigation-po content-navigation">
          Замена программного<br> обеспечения
          <div class="nav-after"></div>
        </a>
        <img src="images/dot.png" width="11" height="11" alt="dot">
        <img src="images/dot-active.png" width="11" height="11" alt="dot-active" class="dot-active-smartphone-12 dot-active">



        <!--Порт зарядки-->

        <a href="#smartphone-power-port" class="smartphone-content-navigation-power-port content-navigation">
        Замена разъема<br> зарядки
          <div class="nav-after"></div>
        </a>
        <img src="images/dot.png" width="11" height="11" alt="dot">
        <img src="images/dot-active.png" width="11" height="11" alt="dot-active" class="dot-active-smartphone-13 dot-active">
        ...
        <a href="#smartphone-display" class="smartphone-hover-display"></a>
        <img src="images/smartphone-hover-display.png" width="192" height="335" alt="smartphone-hover-display">


        <!--Кнопка Home-->

        <a href="#smartphone-buttons" class="smartphone-hover-home-btn"></a>
        <img src="images/smartphone-hover-home-btn.png" width="46" height="14" alt="smartphone-hover-home-btn">


        <!--Камера-->
        <a href="#smartphone-camera" class="smartphone-hover-camera2"></a>
        <a href="#smartphone-camera" class="smartphone-hover-camera"></a>
        <img src="images/smartphone-hover-camera.png" width="297" height="86" alt="smartphone-hover-camera">


        <!--Кнопка включения-->
        <a href="#smartphone-buttons" class="smartphone-hover-button"></a>
        <img src="images/smartphone-hover-button.png" width="32" height="62" alt="smartphone-hover-button">


        <!--Динамики-->
        <a href="#smartphone-dynamics" class="smartphone-hover-speaker2"></a>
        <a href="#smartphone-dynamics" class="smartphone-hover-speaker"></a>
        <img src="images/smartphone-hover-speaker.png" width="292" height="385" alt="smartphone-hover-speaker">



         <!--Аккумулятор-->
        <a href="#smartphone-battery" class="smartphone-hover-battery"></a>
        <img src="images/smartphone-hover-battery.png" width="220" height="425" alt="smartphone-hover-battery">



         <!--Микрофон-->
         <a href="#smartphone-mic" class="smartphone-hover-mic2"></a>
        <a href="#smartphone-mic" class="smartphone-hover-mic"></a>
        <img src="images/smartphone-hover-mic.png" width="429" height="53" alt="smartphone-hover-mic">



        <!--Кнопки громкости-->
         <a href="#smartphone-buttons" class="smartphone-hover-sound-btn2"></a>
        <a href="#smartphone-buttons" class="smartphone-hover-sound-btn"></a>
        <img src="images/smartphone-hover-sound-btn.png" width="305" height="106" alt="smartphone-hover-sound-btn">



        <!--Наушники-->
         <a href="#smartphone-headphones" class="smartphone-hover-headphones2"></a>
        <a href="#smartphone-headphones" class="smartphone-hover-headphones"></a>
        <img src="images/smartphone-hover-headphones.png" width="223" height="23" alt="smartphone-hover-headphones">



        <!--ПО-->
        <a href="#" class="smartphone-hover-po"></a>
        <img src="images/smartphone-hover-po.png" width="193" height="334" alt="smartphone-hover-water" class="smartphone-hover-water">
    ...
    <div class="price-block clearfix">
      <div class="page-line">
        <h2 class="price-title" id="smartphone-headphones">Замена разъема наушников</h2>

        <div class="price-block-image">
          <img src="images/smartphone/smartphone-headphones-photo.jpg" width="360" height="360" alt="smartphone-headphones">
        </div>
    ...
    <div class="price-block clearfix">
      <div class="page-line">
        <h2 class="price-title" id="smartphone-buttons">Замена кнопок</h2>

        <div class="price-block-image">
          <img src="images/smartphone/smartphone-buttons-photo.jpg" width="360" height="360" alt="smartphone-buttons">
        </div>
    ...
    <div class="price-block clearfix">
      <div class="page-line">
        <h2 class="price-title" id="smartphone-display">Замена дисплея</h2>

        <div class="price-block-image">
          <img src="images/smartphone/smartphone-display-photo.jpg" width="360" height="360" alt="smartphone-display">
        </div>
    ...
    <div class="price-block clearfix">
      <div class="page-line">
        <h2 class="price-title" id="smartphone-po">Замена программного обеспечения</h2>

        <div class="price-block-image">
          <img src="images/smartphone/smartphone-po-photo.jpg" width="360" height="360" alt="smartphone-po">
        </div>
    ...
    <div class="price-block clearfix">
      <div class="page-line">
        <h2 class="price-title" id="smartphone-camera">Замена камеры, датчика приближения</h2>

        <div class="price-block-image">
          <img src="images/smartphone/smartphone-camera-photo.jpg" width="360" height="360" alt="smartphone-camera">
        </div>
    ...
    <div class="price-block clearfix">
      <div class="page-line">
        <h2 class="price-title" id="smartphone-battery">Замена аккумулятора</h2>

        <div class="price-block-image">
          <img src="images/smartphone/smartphone-battery-photo.jpg" width="360" height="360" alt="smartphone-battery">
        </div>
    ...
    <div class="price-block clearfix">
      <div class="page-line">
        <h2 class="price-title" id="smartphone-dynamics">Замена динамиков</h2>

        <div class="price-block-image">
          <img src="images/smartphone/smartphone-dynamics-photo.jpg" width="360" height="360" alt="smartphone-dynamics">
        </div>
    ...
    <div class="price-block clearfix">
      <div class="page-line">
        <h2 class="price-title" id="smartphone-mic">Замена микрофона</h2>

        <div class="price-block-image">
          <img src="images/smartphone/smartphone-mic-photo.jpg" width="360" height="360" alt="smartphone-mic">
        </div>
    ...
    <div class="price-block clearfix">
      <div class="page-line">
        <h2 class="price-title" id="smartphone-power-port">Замена разъёма зарядки</h2>

        <div class="price-block-image">
          <img src="images/smartphone/smartphone-power-port-photo.jpg" width="360" height="360" alt="smartphone-power-port">
        </div>
